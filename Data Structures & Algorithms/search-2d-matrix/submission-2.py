class Solution:
    def searchMatrix(self, matrix: List[List[int]], target: int) -> bool:
        ...
        return False
        '''
        #Bài này nó cho 2 dữ kiện là: 2D tăng dần và index đầu mỗi dòng > index cuối cùng dòng trước
        #Nên cứ suy nghĩ nó là mảng 1 chiều và right pointer = số hàng * cột - 1 
        m, n = len(matrix), len(matrix[0])
        l, r = 0, m * n - 1
